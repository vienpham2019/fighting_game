...
export class Bain extends MagicEnemy {
  constructor({
    position = { x: 0, y: 0 },
    velocity = { x: 0, y: 0 },
    width = 60,
  ...
  drawHitBox() {
    ...
    // c.rect(
    //   this.magic_obj.explosion.position.x,
    //   this.magic_obj.explosion.position.y,
    //   this.magic_obj.explosion.width,
    //   this.magic_obj.explosion.height
    // );
    // c.stroke();
